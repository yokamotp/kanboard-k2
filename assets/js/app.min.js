...
showFiles()}
function uploadFiles(){if(files.length>0){const additionalData=textFormElement?[{'name':textFormElement.name,'value':textFormElement.value}]:[{}]
